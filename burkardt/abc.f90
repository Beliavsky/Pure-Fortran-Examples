...
!
  ...
  real ( kind = rk ), save     :: a_default = 1.0D+00
  real ( kind = rk ), optional :: a_in
  real ( kind = rk ), optional :: a_out
  real ( kind = rk ), save     :: b_default = 2.0D+00
  real ( kind = rk ), optional :: b_in
  real ( kind = rk ), optional :: b_out
  real ( kind = rk ), save     :: c_default = 3.0D+00
