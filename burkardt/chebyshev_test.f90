...
!  Parameters:
!
!    Input, real ( kind = rk ) X, a point where the function is to be evaluated.
!
!    Output, real ( kind = rk ) F1, the function value.
!
  implicit none
...
!    Input,  real ( kind = rk ) X, a point where the function is to be evaluated.
!
!    Output, real ( kind = rk ) F2, the function value.
!
  implicit none
...
!    Input, real ( kind = rk ) X, a point where the function is to be evaluated.
!
!    Output, real ( kind = rk ) F3, the function values.
!
  implicit none
