...
!  Input:
!
!    real ( kind = rk ) X, P, the parameters of the incomplete
...
!    1, X < 0 or P <= 0.
!
!    real ( kind = rk ) GAMMAD, the value of the incomplete
!    Gamma integral.
!
  implicit none
...
!  Input:
!
!    real ( kind = rk ) P,  value of the chi-squared cumulative
!    probability density function.
!    0.000002 <= P <= 0.999998.
!
!    real ( kind = rk ) V, the parameter of the chi-squared probability
!    density function.
!    0 < V.
!
!    real ( kind = rk ) G, the value of log ( Gamma ( V / 2 ) ).
!
!  Output:
!
...
!
!    real ( kind = rk ) PPCHI2, the value of the chi-squared random
