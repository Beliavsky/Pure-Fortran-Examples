...
!
  ...
  integer, parameter :: ldb = max ( m, n )
  integer, parameter :: lwork = n
  integer, parameter :: tau_size = n
...
!
  ...
  integer, parameter :: lda = m
  integer, parameter :: ldb = max ( m, n )
  integer, parameter :: lwork = min ( ml + mu, n )
  integer, parameter :: tau_size = n
