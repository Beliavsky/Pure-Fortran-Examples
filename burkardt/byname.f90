...
!
  ...
  real ( kind = rk ), save :: alpha = 1.0D+00
  real ( kind = rk ), save :: alpha_default = 1.0D+00
  real ( kind = rk ), save :: beta = 2.0D+00
  real ( kind = rk ), save :: beta_default = 2.0D+00
  real ( kind = rk ), save :: gamma = 3.0D+00
  real ( kind = rk ), save :: gamma_default = 3.0D+00
  logical match
  character ( len = * ), optional :: name
  character ( len = 1 ) :: name2
  real ( kind = rk ), optional :: value_in
  real ( kind = rk ), optional :: value_out
!
