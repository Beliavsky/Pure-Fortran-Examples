...
!*****************************************************************************80
!
!! compute_pi_openmp() estimates Pi, using OpenMP.
!
!  Discussion:
!
...
!*****************************************************************************80
!
!! R8_TEST estimates the value of PI.
!
!  Discussion:
!
!    PI is estimated using N terms.  N is increased from 10^2 to 10^LOGN_MAX.
!    The calculation is repeated using both sequential and OpenMP enabled code.
...
!*****************************************************************************80
!
!! R8_PI_EST_OMP estimates the value of PI, using OpenMP.
!
!  Discussion:
!
...
!
!    Output, real ( kind = rk ) ESTIMATE, the estimated value of pi.
!
  implicit none
...
!$omp end parallel
  ...
  estimate = 4.0D+00 * sum2 / real ( n, kind = rk )
