...
!*****************************************************************************80
!
!! burgers_exact_test() tests burgers_exact().
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'burgers_exact_test():'
  write ( *, '(a)' ) '  Fortran90 version'
  write ( *, '(a)' ) '  Test burgers_exact().'
...
!
  ...
  filename = 'burgers_exact_test01.txt'
...
!
  ...
  filename = 'burgers_exact_test02.txt'
...
!
  ...
  filename = 'burgers_exact_test03.txt'
...
!
  ...
  filename = 'burgers_exact_test04.txt'
