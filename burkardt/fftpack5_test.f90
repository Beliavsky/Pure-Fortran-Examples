...
!
  lensav = 2 * n + int ( log ( real ( n ) ) / log ( 2.0E+00 ) ) + 4
  lenwrk = 2 * n
...
!
  ...
  lensav = 2 * l + int ( log ( real ( l ) ) / log ( 2.0E+00 ) ) &
...
subroutine dcosq1_test ( )

!*****************************************************************************80
!
!! dcosq1_test tests DCOSQ1B, DCOSQ1F and DCOSQ1I.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
subroutine dcost1_test ( )

!*****************************************************************************80
!
!! dcost1_test tests DCOST1B, DCOST1F, DCOST1I.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  integer, parameter :: n = 4096
  integer, parameter :: lenwrk = n - 1
  integer, parameter :: lensav = 8204
...
subroutine dfft1_test ( )

!*****************************************************************************80
!
!! dfft1_test tests DFFT1B, DFFT1F and DFFT1I.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
subroutine dsint1_test ( )

!*****************************************************************************80
!
!! dsint1_test tests DSINT1B, DSINT1F, DSINT1I.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  integer, parameter :: n = 4096
  integer, parameter :: lenwrk = 8194
  integer, parameter :: lensav = 6156
...
!
  lenwrk = 2 * ( n + 1 )
  lensav = n / 2 + n + int ( log ( real ( n ) ) / log ( 2.0E+00 ) ) + 4
...
subroutine zfft1_test ( )

!*****************************************************************************80
!
!! zfft1_test tests ZFFT1B, ZFFT1F and ZFFT1I.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!  Set work arrays.
!
  lensav = 2 * n + int ( log ( real ( n, kind = rk ) ) ) + 4
  lenwrk = 2 * n
...
subroutine zfft2_test ( )

!*****************************************************************************80
!
!! zfft2_test tests ZFFT2B, ZFFT2F and ZFFT2I.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!  Set work arrays.
!
  lensav = 2 * ( l + m ) + int ( log ( real ( l, kind = rk ) ) ) &
    + int ( log ( real ( m, kind = rk ) ) ) + 8
  lenwrk = 2 * l * m
...
subroutine zfftm_test ( )

!*****************************************************************************80
!
!! zfftm_test tests ZFFTMB, ZFFTMF and ZFFTMI.
!
!  Licensing:
!
!    This code is distributed under the MIT license.
...
!
  ...
  do j = 1, n
    do i = 1, m
      ...
      theta = 2.0E+00 * pi * ( real ( seed ) * 4.656612875E-10 )
