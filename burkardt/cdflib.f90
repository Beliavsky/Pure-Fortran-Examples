...
!
!  The fact that DCDFLIB assumes that 1.0E+30 is a reasonable
...
!
  ...
  if ( 0 < status ) then
    if ( i99999 == 10 ) then
      go to 10
    else if ( i99999 == 20 ) then
      go to 20
    else if ( i99999 == 90 ) then
      go to 90
    else if ( i99999 == 130 ) then
      go to 130
    else if ( i99999 == 200 ) then
      go to 200
    else if ( i99999 == 270 ) then
      go to 270
    else
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'DINVR - Fatal error!'
      write ( *, '(a)' ) '  Illegal value of I99999.'
      stop 1
    end if
  end if
...
!
  ...
  approx = - dlsqpi - 0.5D+00 * x * x - log ( abs ( x ) )
