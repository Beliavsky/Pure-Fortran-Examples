...
!*****************************************************************************80
!
!! calendar_nyt_test() tests calendar_nyt().
!
!  Licensing:
!
...
!
  ...
  do i = 1, test_num
    ...
    jed1 = r8_uniform_ab ( jed_nyt_epoch, jed_now )
...
!
  ...
  integer issue2
  real ( kind = rk ) jed
  real ( kind = rk ), dimension ( test_num ) :: jed_test = (/ &
