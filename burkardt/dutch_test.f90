...
!
  ...
  real ( kind = rk ) x1
  real ( kind = rk ) x2
  real ( kind = rk ), dimension ( ntest ) :: x3 = &
    (/ 1.0D+00, 3.0D+00, -2.0D+00, 3.0D+00, 2.0D+00, &
       5.0D+00, 5.0D+00, 6.0D+00 /)
  real ( kind = rk ), dimension ( ntest ) :: x4 = &
  ...
  real ( kind = rk ) y1
  real ( kind = rk ) y2
  real ( kind = rk ), dimension ( ntest ) :: y3 = (/ &
    2.0D+00, 2.0D+00, 2.0D+00, -2.0D+00, -3.0D+00, &
    1.0D+00, 5.0D+00, 7.0D+00 /)
  real ( kind = rk ), dimension ( ntest ) :: y4 = (/ &
...
!
  ...
  integer, parameter :: nxy = 8

  integer, dimension ( npoly ) :: poly = (/ 7, 8, 1, 6, 2, 5, 4 /)
  real ( kind = rk ), dimension ( nxy ) :: x = &
    (/ 4.0D+00, 0.0D+00, 0.0D+00, 1.0D+00, 2.0D+00, 2.0D+00, 3.0D+00, 5.0D+00 /)
  real ( kind = rk ), dimension ( nxy ) :: y = &
...
!
  ...
  integer color(n)
  integer, dimension ( 3, n-2 ) :: triang =  reshape ( (/ &
    11,    12,    10, &
    12,    13,    10, &
    10,    13,     9, &
     9,    13,     8, &
