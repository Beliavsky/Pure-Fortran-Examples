...
!    -1 <= X <= +1.
!
!    Input, real ( kind = rk ) COEF(NC), the Chebyshev series.
!
!    Input, integer NC, the number of terms in the series.
!    0 < NC.
!
!    Output, real ( kind = rk ) Y0, the value of the Chebyshev series at X.
!
  implicit none
...
!    Output, real ( kind = rk ) Y0, the value of the Chebyshev series at X.
!
!    Output, real ( kind = rk ) Y1, the value of the 1st derivative of the
...
!    Chebyshev series at X.
!
!    Output, real ( kind = rk ) Y2, the value of the 2nd derivative of the
!    Chebyshev series at X.
!
  implicit none
...
!    Chebyshev series at X.
!
!    Output, real ( kind = rk ) Y3, the value of the 3rd derivative of the
!    Chebyshev series at X.
!
  implicit none
...
!    0 < NC.
!
!    Output, real ( kind = rk ) Y0, Y1, Y2, Y3, Y4, the value of the 
