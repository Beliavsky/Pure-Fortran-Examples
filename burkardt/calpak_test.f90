...
!
  ...
  real ( kind = rk ) f1
  real ( kind = rk ) f2
  real ( kind = rk ), parameter :: fhi = 0.0D+00
  real ( kind = rk ), parameter :: flo = 0.0D+00
  integer i
  integer ierror
  integer j1
  integer j2
  integer, parameter :: jhi = 1
  integer, parameter :: jlo = 1
  character ( len = 20 ) s1
  character ( len = 20 ) s2
  integer y1
  integer y2
  ...
  do i = 1, 10
    ...
    call yjf_uniform_common ( ylo, jlo, flo, yhi, jhi, fhi, y1, j1, f1 )
    call yjf_to_s_common ( y1, j1, f1, s1 )

    call yjf_uniform_common ( ylo, jlo, flo, yhi, jhi, fhi, y2, j2, f2 )
    call yjf_to_s_common ( y2, j2, f2, s2 )
...
!
  ...
  real ( kind = rk ) f2
  real ( kind = rk ) f3
  real ( kind = rk ), parameter :: flo = 0.0
  real ( kind = rk ), parameter :: fhi = 0.0
  integer i
  integer j2
  integer m1
  integer m3
...
!
  ...
  do i = 1, 5
    ...
    call yjf_uniform_common ( ylo, jlo, flo, yhi, jhi, fhi, &
      y1, j1, f1 )
...
!
  ...
  integer y1
  integer y2
  integer, parameter :: yhi = 1960
  integer, parameter :: ylo = 1970
...
!
  ...
  integer d3
  integer d4
  real ( kind = rk ), parameter :: days = 10.25D+00
  integer, parameter :: dhi = 1
  integer, parameter :: dlo = 1
  real ( kind = rk ) f1
  real ( kind = rk ) f2
