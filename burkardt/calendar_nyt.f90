...
!  Input:
!
!    integer Y, integer M, integer D, a year, month, and day
!    representing a date.  On D might be negative.
!
!  Output:
!
!    integer Y, integer M, integer D, the date after borrowing. 
!
  implicit none
...
!  Output:
!
!    integer Y, integer M, integer D, the date after carrying. 
!
  implicit none
...
!  Input:
!
!    integer Y, integer M, integer D, the YMD date.
!
!  Output:
!
!    integer Y, integer M, integer D, the YMD date after deflation.
!
  implicit none
...
!  Input:
!
!    integer Y, integer M, integer D, real ( kind = rk ) F, a YMDF date.
!
!  Output:
!
!    integer Y, integer M, integer D, real ( kind = rk ) F, 
!    the date after borrowing.
!
  implicit none
...
!  Input:
!
!    real ( kind = rk ) F, the number to be written into the string.
!    F should be between 0.0 and 1.0.
!
!  Output:
!
!    character ( len = * ) S, a representation of F.
!
  implicit none
...
!  Output:
!
!    integer I4_MODP, the positive remainder
...
!  Output:
!
!    integer Y, integer M, integer D, the YMD date after inflation.
!
  implicit none
...
!  Input:
!
!    real ( kind = rk ) JED, the Julian Ephemeris Date.
!
!  Output:
!
!    integer VOLUME, ISSUE, the New York Times
!    volume and issue.
!
  implicit none
...
!  Output:
!
!    integer ISSUE_IDEAL, the ideal NYT issue number.
!
  implicit none
...
!
  ...
  days = int ( min ( jed, jed_20_04_1861 ) - jed_epoch )
  sundays =  ( days + 3 ) / 7
...
!
  ...
  if ( jed_10_08_1978 <= jed ) then
    issue_ideal = issue_ideal &
      - int ( min ( jed_05_11_1978, jed ) - jed_10_08_1978 ) - 1
  end if
...
!  Output:
!
!    integer Y, integer M, integer D, real ( kind = rk ) F, the YMDF date.
!
  implicit none
...
!
!    integer Y, integer M,
!    integer D, real ( kind = rk ) F, the YMDF date.
!
  implicit none
...
!  Input:
!
!    integer Y, integer M, the YM date.  M might be negative.
!
!  Output:
!
!    integer Y, integer M, the YM date.
!    The date after borrowing.
!
  implicit none
...
!  Input:
!
!    integer Y, integer M, the YM date.  M might be too large.
!
!  Output:
!
!    integer Y, integer M, the YM date.
...
!  Output:
!
!    integer MONTH_LENGTH_COMMON, the number of
!    days in the month.
!
  implicit none
...
!  Output:
!
!    integer MONTH_LENGTH_JULIAN, the number of days
!    in the month.
!
  implicit none
...
!  Input:
!
!    integer VOLUME, ISSUE, the New York Times volume and issue.
!
!  Output:
!
!    integer Y, M, D, the year, month and day.
!
  implicit none
...
!  Output:
!
!    real ( kind = rk ) JED, the Julian Ephemeris Date of the date.
!
  implicit none
...
!  Output:
!
!    logical YEAR_IS_LEAP_COMMON, TRUE if the year was a leap year,
!    FALSE otherwise.
!
  implicit none
...
!  Output:
!
!    logical YEAR_IS_LEAP_GREGORIAN, TRUE if the year was a leap year,
!    FALSE otherwise.
!
  implicit none
...
!  Output:
!
!    logical YEAR_IS_LEAP_JULIAN, TRUE if the year was a leap year,
!    FALSE otherwise.
!
  implicit none
...
!  Output:
!
!    integer YEAR_LENGTH_MONTHS_COMMON, the number of
!    months in the year.
!
  implicit none
...
!  Output:
!
!    integer YEAR_LENGTH_MONTHS_GREGORIAN, the number of months
!    in the year.
!
  implicit none
...
!  Output:
!
!    integer YEAR_LENGTH_MONTHS_JULIAN, the number of 
!    months in the year.
!
  implicit none
...
!  Input:
!
!    integer Y, M, the date.
!
!  Output:
!
!    integer Y, M: the data, after possible correction.
!
!    integer IERROR, is 0 if no error was found,
!    and 1 otherwise.
!
  implicit none
...
!  Output:
!
!    integer Y, M: the date, after possible correction.
!
!    integer IERROR, is 0 if no error was found,
!    and 1 otherwise.
!
...
!    integer Y, M: the date, after possible correction.
!
!    integer IERROR, is 0 if no error was found in the 
...
!  Output:
!
!    integer Y, M, D: the date, after possible correction.
!
!    integer IERROR, is 0 if the date is legal.
!
  implicit none
...
!  Output:
!
!    character ( len = * ) S, a representation of the date.
!
  implicit none
...
!  Output:
!
!    integer Y, M, D, real ( kind = rk ) F: the date after possible correction.
!
!    integer IERROR, is 0 if the date is legal.
!
  implicit none
...
!  Output:
!
!    integer Y, integer M, integer D, real ( kind = rk ) F, the
...
!  Input:
!
!    integer Y1, integer M1, integer D1, real ( kind = rk ) F1, 
!    the first YMDF date.
!
!    integer Y2, integer M2, integer D2, real ( kind = rk ) F2, 
