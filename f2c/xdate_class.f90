...
type :: date
   ...
   integer :: month
contains
   procedure :: date_write
   generic :: write(formatted) => date_write
end type date
...
subroutine date_write(dtv, unit, iotype, v_list, iostat, iomsg)
class(date), intent(in) :: dtv
...
iostat = 0
iomsg = ""
write(unit,'(i4.4,"-",i2.2)',iostat=iostat,iomsg=iomsg) dtv%year, dtv%month
end subroutine date_write
...
print *, "d1 + 5 months =", d4
print *, "d2 - 7 months =", d5
d5 = 3 + d1
print *, "3 + d1        =", d5
print *
